...
import com.ms.entity.StoreInfo;
import com.ms.global.Global;
import com.ms.ks.R;
import com.ms.ks.StatisticsActivity;
import com.ms.ks.ThisMonthAllOrderActivity;
import com.ms.ks.ThisMonthDayOrderActivity;
import com.ms.ks.TodayAllOrderActivity;
...
public class BranchStoreAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        SysUtils.setLine( holder.set_item_2, Global.SET_CELLWHITE, "昨日营业额", R.drawable.icon_item_2, new View.OnClickListener() {
            @Override
        ...
        SysUtils.setLine( holder.set_item_3, Global.SET_CELLWHITE, "本月营业额", R.drawable.icon_item_3, new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                account_id=branch_list.get(position).getStore_no();
                toMonthOrderList(6);
        ...
        SysUtils.setLine( holder.set_item_5, Global.SET_CELLWHITE, "上月营业额", R.drawable.icon_item_3, new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                account_id=branch_list.get(position).getStore_no();
                toMonthOrderList(7);
...
//                                ad_list.add(b);
                    ...
                    progressDialog = DialogUtils.createLoadingDialog(context, "请稍等！", true);
                    progressDialog.show();
                }else{
                    click++;
