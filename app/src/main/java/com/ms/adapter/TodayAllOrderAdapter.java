...
public class TodayAllOrderAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(data!=null){
            if(type==1){
                holder.tv_orderlist_date.setText("今天");
            }else if(type==2){
                holder.tv_orderlist_date.setText("昨天");
            }else if(type==0){
            ...
            holder.tv_payment.setText(data.getPaymentStr());
            holder.tv_sendtype.setText(data.getShippingStr(holder.tv_sendtype));
