...
import com.ms.adapter.ChooseGoodsSortListAdapter;
import com.ms.adapter.OpenOrderGoodListAdapter;
import com.ms.adapter.OpenOrderGoodSquareAdapter;
import com.ms.adapter.ShoppingCarAdapter;
...
import com.ms.entity.Goods_info_type;
import com.ms.entity.OpenOrderGoodList_Choose;
import com.ms.entity.OrderGoods;
import com.ms.global.Global;
import com.ms.ks.AddGoodsActivity;
import com.ms.ks.OpenOrderActivity;
import com.ms.ks.R;
                            ...
                            for(int i=0;i<catagory_infos.length();i++){
                                ...
                                if(pro_info!=null){
                                    for(int w=0;w<pro_info.length();w++){
                                        ...
                                        Goods_info goodsInfo=new Goods_info(name,"",goods_id,Integer.parseInt(buy_count),Integer.parseInt(store),Double.parseDouble(price),img_src,0,0,tag_id,false,0,"","");
                                        goodsinfoList.add(goodsInfo);
                                    }
                                }
...
//                        getActivity().sendBroadcast(new Intent(Global.BROADCAST_ChooseGoodsFrament_ACTION).putExtra("isok",true));
        ...
        progressDialog = DialogUtils.createLoadingDialog(mContext, "请稍等...", true);
        progressDialog.show();
    }
