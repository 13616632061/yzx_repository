...
import com.ms.ks.PutReportActivity;
import com.ms.ks.R;
...
public class ReportFragment extends BaseFragment {
    ...
    private LinearLayout move_report,cash_report;
    private TextView tv_move_report,tv_cash_report,tv_put_report;
    private View move_report_view,cash_report_view;
...
//        mainAct.updateView("home");
        ...
        tv_put_report.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(getActivity(),PutReportActivity.class);
