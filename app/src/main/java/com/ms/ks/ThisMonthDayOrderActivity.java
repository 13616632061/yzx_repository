...
import com.ms.adapter.MonthAllOrderAdapter;
import com.ms.adapter.TodayAllOrderAdapter;
import com.ms.entity.MonthDay_Order;
...
public class ThisMonthDayOrderActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(intent!=null){
            ...
            if (type==1){
                setToolbarTitle("本月营业额");
            }else if(type==2){
                setToolbarTitle("上月营业额");
            }else if(type==5){
...
//            Log.v("ks", "size: " + cat_list.size());
    ...
    private  void setshowTotalstistics(){
        ...
        tv_week.setText(DateUtils.friendly_time2(datetime));
        if(total>0) {
    ...
    private void loadData() {
        ...
        showLoading(ThisMonthDayOrderActivity.this,"请稍等!");
    }
    //    更新适配器
