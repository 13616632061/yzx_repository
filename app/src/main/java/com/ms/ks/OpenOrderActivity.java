...
import com.ms.fragment.BaseFragmentMainBranch;
import com.ms.fragment.ChooseGoodsFrament;
import com.ms.fragment.ChooseScanCodeFragment;
...
import com.ms.util.NoDoubleClickUtils;
...
//                            tel,order_print_id,goodsList,order,num1);
    ...
    private void initView() {
        ...
        btn_good.setText("选择商品");
        btn_sort.setText("扫描选择");
    ...
    private void  do_handle_alertDialog(){
        ...
        if (cursor.moveToFirst()) {
            AlertDialog.Builder alertDialog = new AlertDialog.Builder(OpenOrderActivity.this, R.style.AlertDialog)
                    .setMessage("有商品未处理？                             ")
                    .setPositiveButton("去处理", new DialogInterface.OnClickListener() {
                        @Override
        ...
        tv_sure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!TextUtils.isEmpty(et_accountinfo_input.getText().toString().trim())){
                    ...
                    Toast.makeText(OpenOrderActivity.this,"请输入备注内容！",Toast.LENGTH_SHORT).show();
                }
            }
        });
        //不备注
